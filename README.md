...
This project is a huddle landing page
...
<div align="center" style="display: flex; align-items: center; gap: 16px; max-height: 600px">
  <img src=".github/screenshot.png" alt="Desktop view application" width="400px">
  <img src=".github/screenshot2.png" alt="Mobile view application" height="350px" >
</div>

## :paperclip: Links:

- Solution URL: https://www.frontendmentor.io/solutions/huddle-landing-page--rfYXUr5_o
- Live Site URL: https://i-ramoss.github.io/huddle-landing-page/
...
This project in under MIT license, for more details check in [LICENSE](https://github.com/i-ramoss/huddle-landing-page/blob/main/LICENSE). <br>
